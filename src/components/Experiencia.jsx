...
const Experiencia = () => {
    return (
        <SectionContainer id="experiencia">
            ...
            <SectionInfo>
                <p>Actualmente, <Highlight>no tengo experiencia laboral </Highlight> formal en el sector, pero he <Highlight>trabajado </Highlight>  en varios <Highlight>proyectos </Highlight> que <Highlight> demuestran </Highlight>  mis <Highlight>habilidades técnicas</Highlight>. Estos <Highlight>proyectos</Highlight>, que se describen a <Highlight>continuación</Highlight>, reflejan mi <Highlight>capacidad</Highlight> para <Highlight>aplicar </Highlight>lo <Highlight>aprendido</Highlight> y <Highlight> desarrollar soluciones efectivas.</Highlight> </p>
            </SectionInfo>
        </SectionContainer>
    );
};
